          ...
          <div className="container">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-lg leading-8 text-muted-foreground">
                Search across AI, finance, social media, kids learning, and systems thinking inside the {blogTitle}.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-3 sm:flex-row">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  placeholder="Search AI, finance, social media, kids, systems..."
            ...
            {results.length === 0 ? (
              <div className="rounded-[2rem] border bg-card p-10 text-center shadow-sm">
                ...
                <p className="mt-3 text-muted-foreground">
                  Try broader terms like AI, finance, creators, kids, or systems.
                </p>
              </div>
            ) : (
